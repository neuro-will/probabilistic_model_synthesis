...
# ======================================================================================================================
ps['note'] = 'Publication results - figure 5 paired cross-fold analysis with target-only early stopping.'
...
ps['data_dir'] = str(REPO_ROOT / 'data')

# Folder with the segment table in it
ps['segment_table_dir'] = str(REPO_ROOT / 'data/fold_and_segment_structures')

# File with the segment table in it
ps['segment_table_file'] = r'omr_l_r_f_ns_across_cond_segments_8_9_10_11.json'

# Folder with the fold structure in it
ps['fold_str_dir'] = str(REPO_ROOT / 'data/fold_and_segment_structures/gnldr_paired')
