...
parser = argparse.ArgumentParser(description=('Fits FA dimensionality reduction models to neural data from Chen et ' +
                                              'al. datasets.  This is a general purpose script which can be used for ' +
...
# ======================================================================================================================
if ps['results_dir'] is not None:
    os.makedirs(ps['results_dir'], exist_ok=True)
...
# ======================================================================================================================
fit_rs, subject_order = syn_ahrens_fa_mdls(fold_str_dir=ps['fold_str_dir'],
