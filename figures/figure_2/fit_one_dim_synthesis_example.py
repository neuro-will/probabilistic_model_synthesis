...
parser = argparse.ArgumentParser(description="Fit the one-dimensional simulated DPMS synthesis example.")
parser.add_argument(
    "--save-folder",
    type=str,
    default=None,
    help="Directory where results and checkpoints should be saved.",
)
