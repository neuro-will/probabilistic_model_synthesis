...
- `/data/fold_and_segment_structures/phototaxis_ns_subjects_1_2_5_6_8_9_10_11.pkl`
- `/data/fold_and_segment_structures/Fill in`

Note that fold structure files are not used in the current code setup.
...
```bash
python /data_handling_notebooks/Fill in
```
