...
Generated artifacts are organized by manuscript figure under `results/<figure>/`. Model fits, checkpoints, and post-processed data are written to each figure's `runs/` directory; rendered panels are written to its `figures/` directory. These directories are created automatically.
...
Expected output: the illustrative manuscript panels under `results/figure_1/figures/`.
...
python figures/figure_2/fit_one_dim_synthesis_example.py \
  --save-folder results/figure_2/runs
```
...
Expected output includes `full_simulations.pt` and checkpoint folders under `results/figure_2/runs/`, with SVG panels under `results/figure_2/figures/`.
...
python figures/figure_3/syn_ahrens_gnlr_mdls.py \
  results/figure_3/runs/fit_params.pkl \
  -results_dir results/figure_3/runs/example_fit \
...
python figures/figure_3/post_process.py \
  results/figure_3/runs/example_fit/fit_results.pt \
  results/figure_3/runs/example_fit/pp_fit_results.pkl \
...
Expected output includes `fit_results.pt` and `pp_fit_results.pkl` under `results/figure_3/runs/`, with Figure 3 panels under `results/figure_3/figures/`.
...
Expected output: checkpoints under `results/figure_4_and_S2/runs/` and latent-space and anatomical visualization panels under `results/figure_4_and_S2/figures/`.
...
python figures/figure_5/syn_ahrens_gnldr_mdls.py \
  results/figure_5/runs/fit_params_paired.pkl \
  -results_dir results/figure_5/runs/example_fit \
...
python figures/figure_5/post_process.py \
  results/figure_5/runs/example_fit/fit_results.pt \
  results/figure_5/runs/example_fit/pp_fit_results.pt \
  -early_stopping_subjects 8 \
...
Expected output includes model and post-processed result files under `results/figure_5/runs/`, with per-fish, mean-delta, and positive-count heatmaps under `results/figure_5/figures/`.
...
```text
results/figure_S1/runs/reg_synthesis_with_varying_n_ex_systems.pkl
results/figure_S1/figures/reg_synthesis_with_varying_n_ex_systems.svg
```
